...
export default function Home() {
  return (
    ...
    <div className="p-10 font-jersey h-300 bg-gradient-to-br from-[#151023] to-purple-700 text-[#D19BFF]">
      ...
      <div className="grid grid-cols-2 gap-4 my-10 text-2xl">
        <div className="p-15 border text-center">
          {/* !!! ------- CREATE YOUR OWN SUBPAGE HERE + ADD LINK -------- !!!  */}
          <Link href="/game2">Game2 - Sara+Natalie Demo </Link>
        </div>
        <div className="p-15 border text-center">
          {/* !!! ------- CREATE YOUR OWN SUBPAGE HERE + ADD LINK -------- !!!  */}
          <Link href="/game3">Game3 - Ishani+Izzy Demo </Link>
        </div>
        <div className="p-15 border text-center">
          {/* !!! ------- CREATE YOUR OWN SUBPAGE HERE + ADD LINK -------- !!!  */}
          <Link href="/game5">Game5 - Samhita Demo </Link>
        </div>
        <div className="p-15 border text-center">
          {/* !!! ------- CREATE YOUR OWN SUBPAGE HERE + ADD LINK -------- !!!  */}
          <Link href="/game4">Game4 - Tanvi Demo </Link>
        </div>
